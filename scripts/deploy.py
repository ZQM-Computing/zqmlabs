...
DATA_CACHE = VOLUSIA_PORTAL / "data"
...
STATIC_CATEGORIES = [
    ...
    "real-estate", "housing", "education", "government-finance", "public-safety", "health",
]
...
http {{
    include C:/Users/zqmco/scoop/persist/nginx/conf/mime.types;
    ...
    server {{
        ...
        location ^~ /data/ {{
            alias C:/Users/zqmco/scoop/persist/nginx/html/data/;
            try_files $uri =404;
